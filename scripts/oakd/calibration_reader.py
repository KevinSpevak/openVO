...
# Modified from Luxonis DepthAI Calibration Reader
...
with dai.Device() as device:
    ...
    if "OAK-1" in calibData.getEepromData().boardName or "BW1093OAK" in calibData.getEepromData().boardName:
        ...
        M_left_400p = np.array(calibData.getCameraIntrinsics(dai.CameraBoardSocket.LEFT, 640, 400))
        print("LEFT Camera resized intrinsics... 640 x 400")
        print(M_left_400p)
        ...
        M_right_400p = np.array(calibData.getCameraIntrinsics(dai.CameraBoardSocket.RIGHT, 640, 400))
        print("RIGHT Camera resized intrinsics... 640 x 400")
        print(M_right_400p)
        ...
        print("Baseline distance between left and right camera in centimeters")
        print(baseline)
